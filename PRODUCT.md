...
4. **Normal case, never shouty.** Copy is plain, well-written English: normal sentence case in body and links, sentence or title case for headings and titles, with proper punctuation. The affectation to avoid is shouty styling — forced ALL-CAPS / letter-spaced uppercase labels — or an all-lowercase pose. Tone comes from restraint and word choice, not from typographic tricks.
